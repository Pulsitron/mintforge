...
const TERMS_SECTIONS = [
  ...
  {
    heading: "6. Non-Custodial Acknowledgment",
    body: "You retain sole control over your wallet and private keys at all times. MintForge never takes custody of your funds or digital assets, cannot reverse or cancel a blockchain transaction once submitted, and cannot recover lost private keys, seed phrases, or misdirected transactions on your behalf.",
  },
  {
